...
import com.eleven.http.gdo.helper.ClientHelper;
...
/**
 * @author vic Zhou
 * @time 2017-12-31 3:26
 * @des gdo Client 基于okhttp 网络请求
 */

public class GdoClient implements IClient {
    ...
    @Override
    public <T> void get(String url, LinkedHashMap<String, String> header, Object tag, boolean shouldCache, Callback<T> callback) {
